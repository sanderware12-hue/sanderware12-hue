...
# Hauptfenster
root = tk.Tk()
root.title("AES-256 Verschlüsselung v15.0")
root.geometry("600x400")
root.configure(bg="#333333")  # Dunkelgrauer Hintergrund
...
root.option_add('*Entry.background', '#444444')
root.option_add('*Entry.foreground', '#FFFFFF')
root.option_add('*Entry.insertBackground', '#FFFFFF')

# Widgets erstellen
label_date = tk.Label(root, text="Datum (DD.MM.YYYY):", bg="#333333", fg="#FFFFFF")
entry_date = tk.Entry(root, bg="#444444", fg="#FFFFFF", insertbackground="#FFFFFF")
entry_date.insert(0, datetime.now().strftime("%d.%m.%Y"))

label_plaintext = tk.Label(root, text="Text zum Verschlüsseln:", bg="#333333", fg="#FFFFFF")
entry_plaintext = tk.Entry(root, bg="#444444", fg="#FFFFFF", insertbackground="#FFFFFF")

label_ciphertext = tk.Label(root, text="Verschlüsselter Text:", bg="#333333", fg="#FFFFFF")
entry_ciphertext = tk.Entry(root, bg="#444444", fg="#FFFFFF", insertbackground="#FFFFFF")

label_decrypt_output = tk.Label(root, text="Entschlüsselter Text:", bg="#333333", fg="#FFFFFF")
entry_decrypt_output = tk.Entry(root, bg="#444444", fg="#FFFFFF", insertbackground="#FFFFFF")
...
def create_context_menu(widget):
    menu = tk.Menu(widget, tearoff=0, bg="#444444", fg="#FFFFFF")
...
button_encrypt = tk.Button(button_frame, text="Verschlüsseln", command=encrypt_text, bg="#007ACC", fg="#FFFFFF", relief="flat")
button_encrypt.pack(side=tk.LEFT, padx=10)
button_decrypt = tk.Button(button_frame, text="Entschlüsseln", command=decrypt_text, bg="#007ACC", fg="#FFFFFF", relief="flat")
